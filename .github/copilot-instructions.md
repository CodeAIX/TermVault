...
- Implemented a Node.js + TypeScript CLI project in the current workspace.
- Implemented grouped command/snippet management, copy-to-clipboard, direct run, remove, and interactive picker.
